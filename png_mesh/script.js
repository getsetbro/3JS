...
function init() {
  ...
  var texture = new THREE.TextureLoader().load( "./pericrorLogoBox.png" );
...
window.onload = function() {
  ...
  function onDocumentMouseDown( event ) {
    ...
    var meshObjects = [ mesh, mesh2, mesh3 ]; // three.js objects with click handlers we are interested in
